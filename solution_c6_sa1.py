...
# Creating a 'bullet'
# Creating a 'bullet' at [200,200] as x,y location
# 'width' and 'height' of 'bullet' is 5
bullet=pygame.Rect(200,200,5,5)
# Creating a variable 'bulletState' to denote whether it is "ready" or "fired"
# Initially, 'bullet' will be in "ready" state
bulletState="ready"
# Creating YELLOW color by mixing RED and GREEN and named 'YELLOW'
YELLOW=(255,255,0)
...
while True:
  ...
  for event in pygame.event.get():
    ...
    if event.type == pygame.KEYDOWN:
       ...
       # Checking if SPACE key is pressed and 'bulletState' is "ready"
  ...
  #Checking if 'bulletState' is "fired"
  if bulletState=="fired":
      # Finding new x,y coordinates of 'bullet' by calling 'newxy()' 
      # 'bullet.x','bullet.y','20','bangle' as arguments
